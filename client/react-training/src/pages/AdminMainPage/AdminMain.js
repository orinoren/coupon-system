    ...
    <div className="wv-100 hv-100 ">
      ...
      <div className="container">
        <div className="row mt-5 justify-content-evenly  ">
          <div className="col-12 col-md-2 align-self-center mb-5 mb-md-0    offset-7 offset-md-0 ">
            <div
              onClick={() => {
          ...
          <div className="col-12 col-md-2 align-self-center  offset-7 offset-md-0 ">
            <div
              onClick={() => {
